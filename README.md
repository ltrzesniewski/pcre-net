...
[![PCRE](https://img.shields.io/badge/pcre-v10.36-blue.svg)](http://www.pcre.org/)
...
The current version is **0.15.0**, based on PCRE **10.36**. It targets .NET Standard 2.0 and supports the following systems:
