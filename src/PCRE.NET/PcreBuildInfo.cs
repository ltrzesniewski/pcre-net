...
public static unsafe class PcreBuildInfo
{
    ...
    /// </remarks>
    public static PcreBackslashR BackslashR { get; } = (PcreBackslashR)GetConfigUInt32(PcreConstants.PCRE2_CONFIG_BSR);

    /// <summary>
    /// <c>PCRE2_CONFIG_JIT</c> - Indicates if support for just-in-time compiling is available.
    /// </summary>
    public static bool Jit { get; } = GetConfigBool(PcreConstants.PCRE2_CONFIG_JIT);
    ...
    /// </summary>
    public static string JitTarget { get; } = GetConfigString(PcreConstants.PCRE2_CONFIG_JITTARGET);

    /// <summary>
    /// <c>PCRE2_CONFIG_LINKSIZE</c> - Indicates the number of bytes used for internal linkage in compiled regular expressions.
    /// </summary>
    public static uint LinkSize { get; } = GetConfigUInt32(PcreConstants.PCRE2_CONFIG_LINKSIZE);

    /// <summary>
    /// <c>PCRE2_CONFIG_MATCHLIMIT</c> - Returns the default match limit.
    /// </summary>
    public static uint MatchLimit { get; } = GetConfigUInt32(PcreConstants.PCRE2_CONFIG_MATCHLIMIT);

    /// <summary>
    /// <c>PCRE2_CONFIG_NEWLINE</c> - Indicates the default character sequence that is recognized as meaning "newline".
    /// </summary>
    public static PcreNewLine NewLine { get; } = (PcreNewLine)GetConfigUInt32(PcreConstants.PCRE2_CONFIG_NEWLINE);
    ...
    /// </remarks>
    public static uint ParensLimit { get; } = GetConfigUInt32(PcreConstants.PCRE2_CONFIG_PARENSLIMIT);
    ...
    /// </summary>
    public static uint DepthLimit { get; } = GetConfigUInt32(PcreConstants.PCRE2_CONFIG_DEPTHLIMIT);

    /// <summary>
    /// <c>PCRE2_CONFIG_UNICODE</c> - Indicates if Unicode support is available.
    /// </summary>
    public static bool Unicode { get; } = GetConfigBool(PcreConstants.PCRE2_CONFIG_UNICODE);

    /// <summary>
    /// <c>PCRE2_CONFIG_UNICODE_VERSION</c> - Returns the supported Unicode version.
    /// </summary>
    public static string UnicodeVersion { get; } = GetConfigString(PcreConstants.PCRE2_CONFIG_UNICODE_VERSION);

    /// <summary>
    /// <c>PCRE2_CONFIG_VERSION</c> - Returns the PCRE2 version string.
    /// </summary>
    public static string Version { get; } = GetConfigString(PcreConstants.PCRE2_CONFIG_VERSION);

    /// <summary>
    /// <c>PCRE2_CONFIG_HEAPLIMIT</c> - Returns the default limit for the amount of heap memory used for matching, in kibibytes.
    /// </summary>
    public static uint HeapLimit { get; } = GetConfigUInt32(PcreConstants.PCRE2_CONFIG_HEAPLIMIT);

    /// <summary>
    /// <c>PCRE2_CONFIG_NEVER_BACKSLASH_C</c> - Indicates if the use of <c>\C</c> was permanently disabled when PCRE2 was built
    /// </summary>
    public static bool NeverBackslashC { get; } = GetConfigBool(PcreConstants.PCRE2_CONFIG_NEVER_BACKSLASH_C);
    ...
    /// </remarks>
    public static uint CompiledWidths { get; } = GetConfigUInt32(PcreConstants.PCRE2_CONFIG_COMPILED_WIDTHS);

    /// <summary>
    /// <c>PCRE2_CONFIG_TABLES_LENGTH</c> - Gives the length of PCRE2's character processing tables in bytes.
    /// </summary>
    public static uint TablesLength { get; } = GetConfigUInt32(PcreConstants.PCRE2_CONFIG_TABLES_LENGTH);
    ...
    /// </summary>
    public static uint EffectiveLinkSize { get; } = GetConfigUInt32(PcreConstants.PCRE2_CONFIG_EFFECTIVE_LINKSIZE);
