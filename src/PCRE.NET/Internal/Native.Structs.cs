...
unsafe partial class Native8Bit
{
    ...
    internal ref struct pcre2_callout_block
    {
        ...
        public byte* mark; /* Pointer to current mark or NULL */
        public byte* subject; /* The subject being matched */
        ...
        public byte* callout_string; /* String compiled into pattern */
    ...
    internal struct pcre2_substitute_callout_block
    {
        ...
        /* ------------------------ Version 0 ------------------------------- */
        public byte* input; /* Pointer to input subject string */
        public byte* output; /* Pointer to output buffer */
