...
public enum PcreErrorCode
{
    ...
    /// </summary>
    BadOptions = PcreConstants.PCRE2_ERROR_BAD_OPTIONS,

    /// <summary>
    /// <c>PCRE2_ERROR_MISSING_COMMENT_CLOSING</c> - Missing <c>)</c> after <c>(?#</c> comment.
    /// </summary>
    MissingCommentClosing = PcreConstants.PCRE2_ERROR_MISSING_COMMENT_CLOSING,

    /// <summary>
    /// <c>PCRE2_ERROR_PARENTHESES_NEST_TOO_DEEP</c> - Parentheses are too deeply nested.
    /// </summary>
    ParenthesesNestTooDeep = PcreConstants.PCRE2_ERROR_PARENTHESES_NEST_TOO_DEEP,

    /// <summary>
    /// <c>PCRE2_ERROR_PATTERN_TOO_LARGE</c> - Regular expression is too large.
    /// </summary>
    PatternTooLarge = PcreConstants.PCRE2_ERROR_PATTERN_TOO_LARGE,

    /// <summary>
    /// <c>PCRE2_ERROR_HEAP_FAILED</c> - Failed to allocate heap memory.
    /// </summary>
    HeapFailed = PcreConstants.PCRE2_ERROR_HEAP_FAILED,

    /// <summary>
    /// <c>PCRE2_ERROR_UNMATCHED_CLOSING_PARENTHESIS</c> - Unmatched closing parenthesis.
    /// </summary>
    UnmatchedClosingParenthesis = PcreConstants.PCRE2_ERROR_UNMATCHED_CLOSING_PARENTHESIS,

    /// <summary>
    /// <c>PCRE2_ERROR_INTERNAL_CODE_OVERFLOW</c> - Internal error: code overflow.
    /// </summary>
    InternalCodeOverflow = PcreConstants.PCRE2_ERROR_INTERNAL_CODE_OVERFLOW,
    ...
    /// </summary>
    ZeroRelativeReference = PcreConstants.PCRE2_ERROR_ZERO_RELATIVE_REFERENCE,
    ...
    /// </summary>
    UnsupportedEscapeSequence = PcreConstants.PCRE2_ERROR_UNSUPPORTED_ESCAPE_SEQUENCE,

    /// <summary>
    /// <c>PCRE2_ERROR_CALLOUT_NUMBER_TOO_BIG</c> - Number after <c>(?C</c> is greater than 255.
    /// </summary>
    CalloutNumberTooBig = PcreConstants.PCRE2_ERROR_CALLOUT_NUMBER_TOO_BIG,

    /// <summary>
    /// <c>PCRE2_ERROR_MISSING_CALLOUT_CLOSING</c> - Closing parenthesis for <c>(?C</c> expected.
    /// </summary>
    MissingCalloutClosing = PcreConstants.PCRE2_ERROR_MISSING_CALLOUT_CLOSING,

    /// <summary>
    /// <c>PCRE2_ERROR_ESCAPE_INVALID_IN_VERB</c> - Invalid escape sequence in <c>(*VERB)</c> name.
    /// </summary>
    EscapeInvalidInVerb = PcreConstants.PCRE2_ERROR_ESCAPE_INVALID_IN_VERB,

    /// <summary>
    /// <c>PCRE2_ERROR_UNRECOGNIZED_AFTER_QUERY_P</c> - Unrecognized character after <c>(?P</c>
    /// </summary>
    UnrecognizedAfterQueryP = PcreConstants.PCRE2_ERROR_UNRECOGNIZED_AFTER_QUERY_P,
    ...
    /// </summary>
    SupportedOnlyInUnicode = PcreConstants.PCRE2_ERROR_SUPPORTED_ONLY_IN_UNICODE,

    /// <summary>
    /// <c>PCRE2_ERROR_INVALID_HYPHEN_IN_OPTIONS</c> - Invalid hyphen in option setting.
    /// </summary>
    InvalidHyphenInOptions = PcreConstants.PCRE2_ERROR_INVALID_HYPHEN_IN_OPTIONS,

    /// <summary>
    /// <c>PCRE2_ERROR_ALPHA_ASSERTION_UNKNOWN</c> - <c>(*alpha_assertion)</c> not recognized.
    /// </summary>
    AlphaAssertionUnknown = PcreConstants.PCRE2_ERROR_ALPHA_ASSERTION_UNKNOWN,

    /// <summary>
    /// <c>PCRE2_ERROR_SCRIPT_RUN_NOT_AVAILABLE</c> - Script runs require Unicode support, which this version of PCRE2 does not have.
    /// </summary>
    ScriptRunNotAvailable = PcreConstants.PCRE2_ERROR_SCRIPT_RUN_NOT_AVAILABLE,
    ...
    /// </summary>
    MaxVarLookbehindExceeded = PcreConstants.PCRE2_ERROR_MAX_VAR_LOOKBEHIND_EXCEEDED,
    ...
    /// </summary>
    PerlEClassUnexpectedExpr = PcreConstants.PCRE2_ERROR_PERL_ECLASS_UNEXPECTED_EXPR,
    ...
    /// </summary>
    PerlEClassUnexpectedChar = PcreConstants.PCRE2_ERROR_PERL_ECLASS_UNEXPECTED_CHAR,

    /// <summary>
    /// <c>PCRE2_ERROR_EXPECTED_CAPTURE_GROUP</c> - Expected capture group number or name.
    /// </summary>
    ExpectedCaptureGroup = PcreConstants.PCRE2_ERROR_EXPECTED_CAPTURE_GROUP,

    /// <summary>
    /// <c>PCRE2_ERROR_MISSING_OPENING_PARENTHESIS</c> - Missing opening parenthesis.
    /// </summary>
    MissingOpeningParenthesis = PcreConstants.PCRE2_ERROR_MISSING_OPENING_PARENTHESIS,
    ...
    /// </summary>
    RecurseLoop = PcreConstants.PCRE2_ERROR_RECURSELOOP,

    /// <summary>
    /// <c>PCRE2_ERROR_DEPTHLIMIT</c> - Matching depth limit exceeded.
    /// </summary>
    DepthLimit = PcreConstants.PCRE2_ERROR_DEPTHLIMIT,

    /// <summary>
    /// <c>PCRE2_ERROR_UNAVAILABLE</c> - Requested value is not available.
    /// </summary>
    Unavailable = PcreConstants.PCRE2_ERROR_UNAVAILABLE,
    ...
    /// </summary>
    BadRepEscape = PcreConstants.PCRE2_ERROR_BADREPESCAPE,

    /// <summary>
    /// <c>PCRE2_ERROR_REPMISSINGBRACE</c> - Expected closing curly bracket in replacement string.
    /// </summary>
    RepMissingBrace = PcreConstants.PCRE2_ERROR_REPMISSINGBRACE,

    /// <summary>
    /// <c>PCRE2_ERROR_BADSUBSTITUTION</c> - Bad substitution in replacement string.
    /// </summary>
    BadSubstitution = PcreConstants.PCRE2_ERROR_BADSUBSTITUTION,
    ...
    /// </summary>
    BadSerializedData = PcreConstants.PCRE2_ERROR_BADSERIALIZEDDATA,

    /// <summary>
    /// <c>PCRE2_ERROR_HEAPLIMIT</c> - Heap limit exceeded.
    /// </summary>
    HeapLimit = PcreConstants.PCRE2_ERROR_HEAPLIMIT,
