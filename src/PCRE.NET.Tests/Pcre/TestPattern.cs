...
namespace PCRE.Tests.Pcre
{
    public sealed class TestPattern : IEquatable<TestPattern>
    {
        ...
        public bool Equals(TestPattern? other) => other != null && string.Equals(FullString, other.FullString);
        public override int GetHashCode() => FullString?.GetHashCode() ?? 0;

        public override bool Equals(object obj) => Equals(obj as TestPattern);
